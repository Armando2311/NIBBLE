...
export const projects = sqliteTable("projects", {
  ...
  code: text("code").notNull(),
  description: text("description"),
  projectType: text("project_type").notNull().default("defined"),
  ...
  currentBuild: text("current_build"),
  systemRevision: text("system_revision"),
...
export const uploadSessions = sqliteTable("upload_sessions", {
  ...
  folderId: text("folder_id").notNull().references(() => folders.id),
  fileId: text("file_id"),
  reservedFileId: text("reserved_file_id").notNull(),
  reservedVersionId: text("reserved_version_id").notNull(),
  ...
  ...timestamps,
}, (table) => [index("upload_sessions_status_expiry_idx").on(table.status, table.expiresAt)]);
...
export const uploadParts = sqliteTable("upload_parts", {
  ...
  sizeBytes: integer("size_bytes").notNull(),
  createdAt: integer("created_at", { mode: "timestamp_ms" }).notNull(),
}, (table) => [uniqueIndex("upload_parts_session_number_unique").on(table.sessionId, table.partNumber)]);
